...
const Ashu = videolink.replace("/watch/", "/dl/");

function vlc_player() {
    const openAshu = Ashu;
    const openVlc = `vlc://${openAshu}`;
    window.location.href = openVlc;
}

function mx_player() {
    const openAshu = Ashu;
    const openMx = `intent:${openAshu}#Intent;package=com.mxtech.videoplayer.ad;end`;
    window.location.href = openMx;
}

function playit_player() {
    const openAshu = Ashu;
    const openPlayit = `playit://playerv2/video?url=${openAshu}`;
    window.location.href = openPlayit;
}

function s_player() {
    const openAshu = Ashu;
    const openSplayer = `intent:${openAshu}#Intent;action=com.young.simple.player.playback_online;package=com.young.simple.player;end`;
    window.location.href = openSplayer;
}

function km_player() {
    const openAshu = Ashu;
    const openKmplayer = `intent:${openAshu}#Intent;package=com.kmplayer;end`;
    window.location.href = openKmplayer;
}

function hd_player() {
    const openAshu = Ashu;
    const openHDplayer = `intent:${openAshu}#Intent;package=uplayer.video.player;end`;
    window.location.href = openHDplayer;
}

function bisalDownload() {
    const openAshu = Ashu;
    window.location.href = openAshu;
}
